...
<body background="images/003.jpg" style="background-size:100% 100%; background-repeat;">
	...
	<form name="form1" method="post" action="NewUser.jsp"
		...
		<p>&nbsp;</p>
		<table width="443" border="1" align="center" cellpadding="0"
			style="font-weight:bold;" class=retable; background="images/002.jpg"
			...
			<tr>
				...
				<td>
					<div align="left">
						<input type="radio" name="gender" value="1" checked> 男 <input
